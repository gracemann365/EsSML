...
def emotion_detect():
    ...
    # Check if 'language' key exists in info dictionary, if not, provide a default value
    language = info.get('language', 'English')  # Defaulting to 'English' if 'language' key doesn't exist
    link = f"https://www.youtube.com/results?search_query={info['singer']}+{prediction}+{language}+song playlist"
